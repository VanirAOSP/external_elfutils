		...
		GElf_Sym *sym, GElf_Word shndx)
{
  ...
  static Dwfl_Error relocate (Dwfl_Module *mod, Elf *relocated, const GElf_Ehdr *ehdr, struct reloc_symtab_cache *reloc_symtab, Elf_Data *tdata,
...
=======
>>>>>>> linaro_android_4.4:libdwfl/relocate.c
