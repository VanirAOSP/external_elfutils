...
static inline Dwfl_Module *use (Dwfl *dwfl, Dwfl_Module **tailp, Dwfl_Module **prevp, Dwfl_Module *mod)
{
  mod->next = *tailp;
  *tailp = mod;
		    ...
		    GElf_Addr start, GElf_Addr end)
{
  ...
  return use (dwfl, tailp, prevp, mod);
}
